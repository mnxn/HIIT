...
class AppTheme {
  static final workColor = Color.fromRGBO(231, 72, 86, 1);
  ...
  static ThemeData dark() {
    ...
    return ThemeData(
      ...
      accentColor: CupertinoColors.extraLightBackgroundGray,
      iconTheme: IconThemeData(color: CupertinoColors.extraLightBackgroundGray),
      ...
      textTheme: TextTheme(
        ...
        display4: defaultTheme.display4.copyWith(color: CupertinoColors.extraLightBackgroundGray, fontSize: 112),
      ),
    );
  }
